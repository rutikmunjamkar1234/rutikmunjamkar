...
if(isset($Submit))
{
$max_qry=mysql_query("select max(id) from girls");
$max_row=mysql_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;

$qrys=mysql_query("insert into girls values('$id','$sid','$roll','$room','$name','$age','$dept','$year','$mail','$contact','$addr','$uname','$pwd')");
...
<div class="gallery w3-agileits">  
		<div class="container">
		  <div align="center" class="label-primary style5"></div>
		  <form name="form1" method="post" action="">
		    <table width="924" height="532" border="0" align="center">
              ...
              <tr>
                <td width="166" height="37" background="images/G13.jpg" bgcolor="#B8B8B8"><div align="center" class="tooltip-inner">NAME</div></td>
              ...
              <tr>
                <td height="36" background="images/G13.jpg" bgcolor="#B8B8B8"><div align="center" class="tooltip-inner">GENDER</div></td>
                <td background="images/G13.jpg" bgcolor="#B8B8B8"><div align="center">
                    <input name="gender" type="radio" class="alert-success" value="male">
                    <span class="alert-success">MALE</span>
                    <input name="gender" type="radio" class="alert-success" value="female">
                    <span class="alert-success">FEMALE</span></div></td>
                <td width="215" background="images/G13.jpg" bgcolor="#B8B8B8">&nbsp;</td>
              </tr>
              <tr>
