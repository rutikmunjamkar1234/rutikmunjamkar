...
<div class="gallery w3-agileits">  
		<div class="container">
		  <form name="form1" method="post" action="">
            <p align="center" class="text-danger style4">Welcome to boys hostel....!</p>
            <p align="center" class="text-danger style4"><a href="boys_pdf.php" target="_blank"><span class="style6">Generate PDF ...! </span></a></p>
            <table width="935" height="51" border="0" align="center">
              <tr>
                <td><div align="center"><a href="boys_list.php" target="_self" class="style4">SEARCH</a></div></td>
                <td><div align="center" class="style4"><a href="boys_view.php" target="_self">VIEW</a></div></td>
                <td><div align="center" class="style4"><a href="boys_update.php" target="_self">UPDATE</a></div></td>
                <td><div align="center" class="style4"><a href="boys_delete.php" target="_self">DELETE</a></div></td>
              </tr>
            </table>
            <p align="center" class="text-danger style4"><a href="boys_list.php" target="_self"></a></p>
            <table width="843" height="143" border="2" align="center">
              <tr>
              ...
              <?php 
	$xyz=mysql_query("select * from boys ");
while(	$row=mysql_fetch_array($xyz))
{
?>
              <tr>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Student_Id"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Roll"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Name"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Room"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Address"];?></div></td>
              </tr>
              <?php 
	}
	?>
              <tr>
                <td height="37" class="alert-info style8">&nbsp;</td>
                <td class="alert-info style8">&nbsp;</td>
                <td class="alert-info style8">&nbsp;</td>
                <td class="alert-info style8">&nbsp;</td>
                <td class="alert-info style8">&nbsp;</td>
              </tr>
