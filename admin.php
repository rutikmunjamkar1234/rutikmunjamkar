...
{
$qry=mysql_query("select * from admin where User_Name='$uname' && Password='$pwd'");
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">					
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="admin.php" class="link link--yaku"><span>ADMIN</span> </a></li>
...
<div class="gallery w3-agileits">  
		<div class="container">
		  <form name="form1" method="post" action="">
		    <table width="682" height="351" border="0" align="center">
              <tr class="alert-info">
                <td height="36" colspan="3" nowrap background="images/b2.jpg" bgcolor="#FFFFFF"><div align="center" class="list-group-item-info style4">Admin Login Form  </div></td>
              </tr>
              <tr>
                <td width="260" rowspan="2" nowrap background="images/b2.jpg" bgcolor="#FFFFFF"><img src="images/Staff.png" width="250" height="250"></td>
