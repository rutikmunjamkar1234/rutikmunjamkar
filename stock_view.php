...
.style9 {animation: blinkingText 0.5s infinite;
	font-family: "Lucida Calligraphy";
	font-size: 18px;
	color: #FF0000;
}
...
<div class="gallery w3-agileits">  
		<div class="container">
		  <form name="form1" method="post" action="">
            ...
            <p align="center" class="text-danger style4"><a href="stock_pdf.php" target="_blank"><span class="style9">Generate PDF ...! </span></a></p>
            ...
            <table width="1008" height="143" border="2" align="center">
              <tr>
              ...
              <?php 
	$xyz=mysql_query("select * from stock ");
while(	$row=mysql_fetch_array($xyz))
{
?>
              <tr>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Item_Number"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Item_Name"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Date"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Quantity"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Available"];?></div></td>
                <td class="alert-info"><div align="center" class="style8"><?php echo $row["Remarks"];?></div></td>
              </tr>
              <?php 
	}
	?>
