		...
		<div class="container">
		  <blockquote>
		    <form name="form1" method="post" action="boys_invoice.php">
		      ...
		      <p align="center">WELCOME <?PHP echo $roll?></p>
		      <table width="451" height="257" border="0" align="center">
                <tr>
				  ...
				  <?php $xyz=mysql_query("select DISTINCT Student_Id from boys where Roll='$roll'");
                ...
                <tr>
				  ...
				  <?php $xyz=mysql_query("select DISTINCT Roll from boys where Roll='$roll'");
						$row=mysql_fetch_array($xyz);
                ...
                <tr>
                  ...
                  <td class="list-group-item-success"><div align="center">
				    <?php $xyz=mysql_query("select DISTINCT Room from boys where Roll='$roll'");
						$row=mysql_fetch_array($xyz);
                ...
                <tr>
                  ...
                  <td class="list-group-item-success"><div align="center">
				   <?php $xyz=mysql_query("select DISTINCT Name from boys where Roll='$roll'");
						$row=mysql_fetch_array($xyz);
                ...
                <tr>
                  ...
                  <td class="list-group-item-success"><div align="center">
				  <?php $xyz=mysql_query("select DISTINCT Year from boys where Roll='$roll'");
						$row=mysql_fetch_array($xyz);
                ...
                <tr>
                  <td height="52" colspan="2"><div align="center"></div></td>
                </tr>
              </table>
            ...
            <form name="form2" method="post" action="invoice.php">
            </form>
          </blockquote>
		  <p>&nbsp;</p>
